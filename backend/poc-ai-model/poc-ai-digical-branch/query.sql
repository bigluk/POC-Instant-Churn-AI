CREATE TABLE ISBD_USERS (
    ...
    housing VARCHAR(10),
    loan VARCHAR(10),
    inclined_to_invest NUMERIC(1, 0),
...
CREATE TABLE INVESTMENT_PROPENSITY_USER (
    ...
    inclined_to_invest NUMERIC(1, 0) NOT NULL,
...
INSERT INTO INVESTMENT_PROPENSITY_USER (user_id, investment_propensity, inclined_to_invest, timestamp) VALUES
(99017733, 45.00, 0, '2025-01-15 10:30:00+01'),
(99017733, 46.50, 0, '2025-02-15 11:15:00+01'),
(99017733, 48.00, 0, '2025-03-15 09:45:00+01'),
(99017733, 49.50, 0, '2025-04-15 14:20:00+01'),
(99017733, 51.00, 1, '2025-05-15 10:00:00+01'),
(99017733, 52.50, 1, '2025-06-15 11:30:00+01'),
(99017733, 54.00, 1, '2025-07-15 15:45:00+01'),
(99017733, 55.50, 1, '2025-08-15 09:20:00+01'),
(99017733, 57.00, 1, '2025-09-15 13:10:00+01'),
(99017733, 58.50, 1, '2025-10-15 10:50:00+01'),
(99017733, 60.00, 1, '2025-11-15 12:00:00+01');
UPDATE ISBD_USERS SET investment_propensity = 60.00, inclined_to_invest = 1 WHERE id = 99017733;


-- Insert per Oliver Moore (id: 441100) - con crescita del 10% negli ultimi 3 mesi
INSERT INTO INVESTMENT_PROPENSITY_USER (user_id, investment_propensity, inclined_to_invest, timestamp) VALUES
(441100, 65.00, 1, '2025-01-10 14:30:00+01'),
(441100, 66.00, 1, '2025-02-10 15:20:00+01'),
(441100, 67.00, 1, '2025-03-10 11:40:00+01'),
(441100, 68.00, 1, '2025-04-10 16:15:00+01'),
(441100, 69.00, 1, '2025-05-10 10:25:00+01'),
(441100, 70.00, 1, '2025-06-10 13:35:00+01'),
(441100, 71.00, 1, '2025-07-10 09:50:00+01'),
(441100, 72.00, 1, '2025-08-10 12:05:00+01'),
(441100, 79.20, 1, '2025-09-10 14:40:00+01'),
